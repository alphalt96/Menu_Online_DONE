...
public class QuanAnAdapter extends ArrayAdapter<QuanAn> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            viewHolder.img = (ImageView) convertView.findViewById(R.id.imgQuanAn);
            viewHolder.txtTen = (TextView) convertView.findViewById(R.id.txtRenTenQuanAn);
            viewHolder.txtDiaChi = (TextView) convertView.findViewById(R.id.txtRenDiaChi);
