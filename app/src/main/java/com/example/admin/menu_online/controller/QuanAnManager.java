...
//            }
            db.insertQuanAn("Ngọc Nhị", "69 Phần Lăng 8", "Đà Nẵng", R.drawable.quan1, "1 2 3 4 5", 400);
            db.insertQuanAn("KFC", "104 Nguyễn Văn Linh, Nam Dương, Quận Hải Châu", "Đà Nẵng", R.drawable.quan2, "6 7 8 9 10", 400);
            db.insertQuanAn("Zé Food - Thiên Đường Ăn Vặt Online", "112/71 Trần Cao Vân, Quận Thanh Khê, Đà Nẵng", "Đà Nẵng", R.drawable.quan3, "11 12 13 14 15", 400);
            db.insertQuanAn("Highlands Coffee - One Opera Hotel", "01 Nguyễn Văn Linh, Nam Dương, Quận Hải Châu", "Đà Nẵng", R.drawable.quan4, "16 17 18 19 20", 400);
            db.insertQuanAn("EZI Coffee", "30 Ông Ích Khiêm, Quận Hải Châu, Đà Nẵng", "Đà Nẵng", R.drawable.quan5, "21 22 23 24 25", 400);
            db.insertQuanAn("Chói's Kitchen - Món Ăn Hàn Quốc", "02 Hoàng Hoa Thám, Quận Thanh Khê", "Đà Nẵng", R.drawable.quan6, "26 27 28 29 30", 400);
            db.insertQuanAn("Sasin", "315 Nguyễn Văn Linh, Quận Thanh Khê", "Đà Nẵng", R.drawable.quan7, "31 32 33 34 35", 400);
            db.insertQuanAn("The Coffee House", "435 Lê Duẩn, Quận Thanh Khê", "Đà Nẵng", R.drawable.quan8, "36 37 38 39 40", 400);
            db.insertQuanAn("Bingsu - Pizza Đà Nẵng", "73 Đặng Thai Mai, Quận Hải Châu", "Đà Nẵng", R.drawable.quan9, "1 2 3 4 5", 400);
            db.insertQuanAn("Ahihi - Trà Sữa & Ăn Vặt", "107 Lê Đình Lý, Quận Thanh Khê", "Đà Nẵng", R.drawable.quan10, "6 7 8 9 10", 400);
        }
    }
}
